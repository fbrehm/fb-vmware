...
class SimpleTestObject(object):
    """
    A helper class for defining an simple base object.

    Some particular attributes could be defined, which can be used e.g. for testing
    calling from_summary() of some classes.
    """
