...
class VsphereDatacenter(VsphereObject):
    ...
    def __init__(
        ...
        ds_folder=DEFAULT_DS_FOLDER,
        host_folder=DEFAULT_HOST_FOLDER,
        network_folder=DEFAULT_NETWORK_FOLDER,
        vm_folder=DEFAULT_VM_FOLDER,
    ...
    def from_summary(cls, data, appname=None, verbose=0, base_dir=None, test_mode=False):
        ...
        if test_mode:
            ...
            if not isinstance(data, vim.Datacenter):
                ...
                ).format(t="data", e="vim.Datacenter", v=data.__class__.__qualname__)
                raise TypeError(msg)
