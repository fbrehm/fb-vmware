...
class VsphereObject(FbBaseObject):
    ...
    def obj_type(self, value):
        ...
        if val == "":
            msg = _("Invalid {w}.{p} {v!r}.").format(w="VsphereObject", p="type", v=value)
    ...
    def status(self, value):
        ...
        if val not in self.available_status_color:
            msg = _("Invalid {w}.{p} {v!r}.").format(w="VsphereObject", p="status", v=value)
            raise ValueError(msg)
    ...
    def config_status(self, value):
        ...
        if val == "":
            ...
            return
        if val not in self.available_status_color:
            msg = _("Invalid {w}.{p} {v!r}.").format(w="VsphereObject", p="config_status", v=value)
            raise ValueError(msg)
